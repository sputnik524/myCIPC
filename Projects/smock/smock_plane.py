...
if __name__ == "__main__":
    ...
    scale = 0.02
    # add stage garment
    sim.add_shell_with_scale_3D("input/braid/S3.obj", Vector3d(0.0, 0.0, -0.0), Vector3d(scale, scale, scale),\
    ...
    sim.populate(start, end, stage_start, stage_size, scale_pop, y_axis = Vector3d(0.0, -1.0, 0.0))
