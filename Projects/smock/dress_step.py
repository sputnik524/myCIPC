...
if __name__ == "__main__":
    ...
    # add stage garment
    sim.add_shell_with_scale_3D("input/dress/shell1_dynamic_3.obj", Vector3d(0.0, 0.0, -0.0), Vector3d(1.0, 1.0, 1.0),\
        Vector3d(0, 0, 0), Vector3d(1, 0, 0), 0)

    # add mannequin
    meshCounter = sim.add_shell_with_scale_3D("input/f_average_A40.obj", Vector3d(0.0, -1.0, 0.0), \
        Vector3d(1.0, 1.1, 0.8),Vector3d(0, 0, 0), Vector3d(0, 0, 1), 0) 
